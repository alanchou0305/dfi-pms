...
import {
  ...
  initFiles, initFilesEdit, initFileCategories, initFileCategoriesEdit,
...
const ROUTES = {
  ...
  'specs':                 { crumb: ['產品管理', '產品規格'],                    nav: 'nav-specs',               group: 'grp-products' },
  'specs-edit':            { crumb: ['產品管理', '產品規格', '產品規格編輯'],     nav: 'nav-specs',               group: 'grp-products' },
...
const VIEW_INITS = {
  ...
  'file-categories-edit': initFileCategoriesEdit,
  'users':                initUsers,
